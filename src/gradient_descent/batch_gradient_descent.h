#ifndef MACHINELEARNING_GRADIENT_DESCENT_BATCH_GRADIENT_DESCENT_H_
#define MACHINELEARNING_GRADIENT_DESCENT_BATCH_GRADIENT_DESCENT_H
...
#endif // end of  MACHINELEARNING_GRADIENT_DESCENT_BATCH_GRADIENT_DESCENT_H_
